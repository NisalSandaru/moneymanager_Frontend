...
const Input = ({ label, value, onChange, placeholder, type, isSelect, options }) => {
  ...
  return (
    <div className="mb-4">
      <label htmlFor="" className="text-[13px] text-slate-800 block mb-1">
        {label}
      </label>
      <div className="relative">
        {isSelect ? (
          <select 
          className="w-full bg-transparent outline-none border border-gray-300 rounded-md py-2 px3 text-gray-700 leading-0 focus:outline-none focus:border-blue-500" 
          value={value}
